      ...
      <div className="grid">
        ...
        <div className="about-me">
          ...
          <p>
            ...
            me. I started my career as a self-taught Web Developer by learning
            HTML, CSS, javascript & PHP. After a few months, I got a chance to
            work on a Javascript framework (Angular v1.5) and later few months
            down the line, I started working on other javascript frameworks like
            ember, backbone, kendo ui, knockoutjs etc, in different projects. In
            the beginning of my career only, I understood that I liked working
            on the web a lot.
          </p>
          <p>
